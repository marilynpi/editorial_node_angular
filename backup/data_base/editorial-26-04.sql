...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-04-2015 a las 00:49:42
...
(5, 'CHAMPAGNAT', 12345, 'champagnat@maristas.com.ar', 'MONTEVIDEO 1050', 1, 1019, 'PRIVADO', '01', 'CIUDAD DE BS AS', 1, 'Ver a Coord. De lengua Marcela Casaubon'),
(8, 'asad', 341879874, 'asdasd', 'fadsd', 1, 2, 'PUBLICO', '1', '1', 1, 'asdasad'),
(9, 'sadasd', 234, 'zxdc', 'asfd', 1, 1, 'PRIVADO', '1', '1', 1, 'dsdfa'),
(11, 'asdaf', 2354, 'sfsf', 'sadasd', 1, 1, 'PRIVADO', '1', '1', 1, 'asdasd'),
(12, 'asdaf', 2354, 'sfsf', 'sadasd', 1, 1, 'PRIVADO', '1', '1', 1, 'asdasd'),
...
CREATE TABLE IF NOT EXISTS `escuela_ciclo` (
  ...
  PRIMARY KEY (`id_escuela`,`id_ciclos`,`id_turno`,`id_grado`),
...
INSERT INTO `escuela_ciclo` (`id_escuela`, `id_ciclos`, `id_turno`, `id_grado`, `cantidad_grado`) VALUES
(5, 2, 'M', 2, 4),
(5, 2, 'M', 3, 4),
(5, 2, 'M', 4, 4),
(5, 3, 'M', 5, 4),
...
(11356959, 'Daniel', 'Perazzo', 'DNI', '1955-04-08', 'Rosetti 751', 'Muñiz', 1, 1663, 'danperazzo@hotmail.com', 1144514, '2015-04-20');
...
CREATE TABLE IF NOT EXISTS `persona_escuela` (
  ...
  `id_grado` int(11) NOT NULL,
  PRIMARY KEY (`dni`,`id_escuela`,`id_grado`),
...
CREATE TABLE IF NOT EXISTS `persona_grado` (
  ...
  `id_grado` int(11) NOT NULL,
  `id_turno` char(2) NOT NULL,
  PRIMARY KEY (`dni`,`id_grado`,`id_turno`),
  KEY `id_grado` (`id_grado`),
  KEY `id_turno` (`id_turno`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `escuela_ciclo`
  ...
  ADD CONSTRAINT `escuela_ciclo_ibfk_2` FOREIGN KEY (`id_ciclos`) REFERENCES `ciclo` (`id`),
...
ALTER TABLE `persona_escuela`
  ADD CONSTRAINT `persona_escuela_ibfk_5` FOREIGN KEY (`id_escuela`) REFERENCES `escuela` (`id`),
  ...
  ADD CONSTRAINT `persona_escuela_ibfk_4` FOREIGN KEY (`id_grado`) REFERENCES `grado` (`id`);
