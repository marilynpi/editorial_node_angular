...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-05-2015 a las 07:20:20
...
INSERT INTO `ciclo` (`id`, `descripcion`) VALUES
(1, 'Inicial'),
(2, '1 a 3'),
(3, '4 a 7'),
(4, '3er Ciclo'),
...
INSERT INTO `escuela` (`nombre`, `telefono`, `email`, `domicilio`, `localidad`, `cp`, `sector`, `distrito`, `ubicacion`, `provincia`, `observaciones`, `id`) VALUES
('CHAMPAGNAT', 4811, 'champagnat@maristas.com.ar', 'MONTEVIDEO 1050', 309, 1019, 'PRIVADO', '01', 'CIUDAD DE BS AS', 3, 'Ver a Coord. De lengua Marcela Casaubon', 1),
('fsd', 1111, 'sfsdf', 'dfsd', 145, 5, 'PUBLICO', '5', '5', 2, 'ewr', 2),
('asdas', 0, 'sda', 'sad', 2, 1, 'PUBLICO', '1', '12', 1, 'qwae', 5),
('eqwr', 1, 'weq', 'wqe', 371, 8888, 'PUBLICO', '1', '12', 5, 'ewqe', 32),
('asdas', 0, 'sda', 'sad', 2, 1, 'PUBLICO', '1', '12', 1, 'qwae', 123),
('qwe', 324, 'aasd', 'asd', 284, 1663, 'PUBLICO', '1', '1', 3, 'dasd', 346),
('wqe', 1, 'asd', 'as', 283, 1, 'PUBLICO', '1', '1', 3, 'adsa', 777),
('sdf', 12, 'sad', 'asd', 447, 1, 'PUBLICO', '1', '1', 6, '1', 999),
('q', 123, 'aasd', 'asd', 144, 1, 'PUBLICO', '1', 'wqwe', 2, 'asd', 12321),
('qwe', 1, 'asdf', 'wqe', 372, 1, 'PUBLICO', '1', 'asd', 5, 'asd', 26234),
('asd', 1, '1', '1', 441, 1663, 'PUBLICO', '1', '1', 6, '1', 77777),
('asd', 1, '1', '1', 332, 1663, 'PUBLICO', '1', '1', 4, '1', 343434),
('qwe', 1, '1', '1', 1350, 1, 'PUBLICO', '1', '1', 12, '1', 878787),
('asd', 2, 'sad', 'asd', 143, 1, 'PUBLICO', '1', 'aasd', 2, 'asd', 444444444);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `escuela_ciclo`
--

CREATE TABLE IF NOT EXISTS `escuela_ciclo` (
...
--
-- Volcado de datos para la tabla `escuela_ciclo`
--

INSERT INTO `escuela_ciclo` (`id_escuela`, `id_turno`, `id_grado`, `cantidad_grado`, `id_ciclo`) VALUES
(1, 'JC', 1, 2, 1),
(32, 'JC', 1, 4, 1),
(777, 'M', 1, 2, 1),
(777, 'M', 3, 2, 2),
...
INSERT INTO `grado` (`id`, `descripcion`, `id_ciclo`) VALUES
(1, 'Jardín', 1),
(2, '1er Grado', 2),
(3, '2do Grado', 2),
(4, '3er Grado', 2),
...
--
-- Estructura de tabla para la tabla `libro_persona`
--
...
INSERT INTO `persona` (`dni`, `nombre`, `apellido`, `tipo_dni`, `fecha_nac`, `direccion`, `ciudad`, `provincia`, `cp`, `email`, `telefono`, `fecha_alta`) VALUES
(213, 'sad', 'asd', 'DNI', '0000-00-00', 'sad', 'ads', 1, 1, 'asdf', 2133, '0000-00-00'),
(123134, 'asdasd', 'asdasd', 'DNI', '0000-00-00', 'asd', 'af', 3, 1, 'asd', 123, '0000-00-00'),
(11356959, 'Daniel', 'Perazzo', 'DNI', '1955-04-08', 'Rosetti 741', 'Muñiz', 1, 1663, 'danperazzo@hotmail.com', 2147, '2015-04-20');
...
--
-- Filtros para la tabla `escuela_ciclo`
--
ALTER TABLE `escuela_ciclo`
  ADD CONSTRAINT `escuela_ciclo_ibfk_6` FOREIGN KEY (`id_ciclo`) REFERENCES `ciclo` (`id`),
  ADD CONSTRAINT `escuela_ciclo_ibfk_3` FOREIGN KEY (`id_turno`) REFERENCES `turno` (`id`),
  ADD CONSTRAINT `escuela_ciclo_ibfk_4` FOREIGN KEY (`id_escuela`) REFERENCES `escuela` (`id`),
  ADD CONSTRAINT `escuela_ciclo_ibfk_5` FOREIGN KEY (`id_grado`) REFERENCES `grado` (`id`);

--
-- Filtros para la tabla `grado`
--
ALTER TABLE `grado`
  ADD CONSTRAINT `grado_ibfk_1` FOREIGN KEY (`id_ciclo`) REFERENCES `ciclo` (`id`);
...
--
-- Filtros para la tabla `libro_persona`
--
...
--
ALTER TABLE `persona`
  ADD CONSTRAINT `persona_ibfk_1` FOREIGN KEY (`provincia`) REFERENCES `provincia` (`id_provincia`);

--
-- Filtros para la tabla `persona_escuela`
--
...
--
-- Filtros para la tabla `persona_grado`
--
ALTER TABLE `persona_grado`
  ADD CONSTRAINT `persona_grado_ibfk_5` FOREIGN KEY (`id_cargo`) REFERENCES `cargo` (`id`),
  ADD CONSTRAINT `persona_grado_ibfk_1` FOREIGN KEY (`dni`) REFERENCES `persona` (`dni`),
  ADD CONSTRAINT `persona_grado_ibfk_2` FOREIGN KEY (`id_grado`) REFERENCES `grado` (`id`),
  ADD CONSTRAINT `persona_grado_ibfk_3` FOREIGN KEY (`id_turno`) REFERENCES `turno` (`id`),
  ADD CONSTRAINT `persona_grado_ibfk_4` FOREIGN KEY (`id_escuela`) REFERENCES `ciclo` (`id`);
